...
function Signup() {
  ...
  return loader ? (
    ...
    <div className="absolute justify-center items-center top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col gap-5 bg-black/10 text-white rounded w-3/12 min-w-80 py-6">
